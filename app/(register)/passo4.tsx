...
const DEFAULT_FORM_VALUES = {isEntregador: false};
type FormData = {
...
export default function isEntregadorScreen() {
  ...
  const isChecked = watch("isEntregador");
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Passo 4 de 4</Text>
